...
const PACKS_PRESCRIPTEUR = {
  solo: { label: 'Pack Solo', credits: 1, prixHT: 20, prixTTC: 24, stripeKey: 'pack_solo', description: '1 plan alimentaire' },
  dix: { label: 'Pack 10 crédits', credits: 10, prixHT: 180, prixTTC: 216, stripeKey: 'pack_dix', description: '10 plans, économie de 10%' },
  vingt: { label: 'Pack 20 crédits', credits: 20, prixHT: 340, prixTTC: 408, stripeKey: 'pack_vingt', description: '20 plans, économie de 15%' },
  cinquante: { label: 'Pack 50 crédits', credits: 50, prixHT: 840, prixTTC: 1008, stripeKey: 'pack_cinquante', description: '50 plans, économie de 20%' }
};
 ...
 * @param {Object} labelSet - L'objet contenant les labels
 ...
 * @param {number} tva - Taux de TVA (par défaut 20%)
 ...
 * @param {boolean} includeCurrency - Inclure le symbole €
...
console.log('[constants.js] ✅ Chargé avec succès');